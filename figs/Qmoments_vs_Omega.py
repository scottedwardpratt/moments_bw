...
plt.plot(Omega,Ksigma2q_b0,linestyle='-',linewidth=2,color='r',markersize=5, marker='o', markerfacecolor=None, markeredgecolor=None)
plt.plot(Omega,Ssigmaq_b0,linestyle='-',linewidth=2,color='b',markersize=5, marker='o', markerfacecolor=None, markeredgecolor=None)
...
Ssigmaq_b0=mydata[7]
Ksigma2q_b0=mydata[8]
plt.plot(Omega,Ksigma2q_b0,linestyle='-',linewidth=2,color='r',markersize=5, marker='s', markerfacecolor=None, markeredgecolor=None)
plt.plot(Omega,Ssigmaq_b0,linestyle='-',linewidth=2,color='b',markersize=5, marker='s', markerfacecolor=None, markeredgecolor=None)
...
Ssigmaq_b0=mydata[7]
Ksigma2q_b0=mydata[8]
plt.plot(Omega,Ksigma2q_b0,linestyle='-',linewidth=2,color='r',markersize=5, marker='^', markerfacecolor=None, markeredgecolor=None)
plt.plot(Omega,Ssigmaq_b0,linestyle='-',linewidth=2,color='b',markersize=5, marker='^', markerfacecolor=None, markeredgecolor=None)
...
plt.savefig('Qmoments_vs_Omega.pdf',format='pdf')
os.system('xdg-open Qmoments_vs_Omega.pdf')
#plt.show()
quit()
