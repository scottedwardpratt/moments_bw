...
ax.set_yticks(np.arange(-15,13.5,5), minor=False)
ax.set_yticklabels(np.arange(-15,13.5,5), minor=False, family='serif')
ax.set_yticks(np.arange(-15,13.5,1), minor=True)
plt.ylim(-11,5)
ax.yaxis.set_major_formatter(ticker.FormatStrFormatter('%1f'))
ax.yaxis.set_major_formatter(sformatter)
