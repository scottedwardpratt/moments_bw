...
int main(int argc,char *argv[]){
	int N=9,nplus,nminus;
	double Q4bar=0.0,Q2bar=0.0,q,netprob=0.0,alpha,prob;
	...
	for(nplus=0;nplus<=N;nplus++){
		for(nminus=0;nminus<=N;nminus++){
			prob=pow(alpha,nplus)*pow(1.0-alpha,N-nplus)*pow(alpha,nminus)*pow(1.0-alpha,N-nminus);
